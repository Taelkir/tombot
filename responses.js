...
// @tombot reply
exports.youTalkingToMe = (message, cleanedMessage, client) => {
	if (message.isMemberMentioned(client.user)) {
		const author = message.author;
		return `You talkin' to me, ${author}?`;
	}
};
...
exports.tom = (message, cleanedMessage, client) => {
	const author = message.author;
...
exports.hewwo = (message, cleanedMessage, client) => {
...
exports.goodnight = (message, cleanedMessage, client) => {
	const author = message.author;
...
exports.hmmm = (message, cleanedMessage, client) => {
	const hmmPattern = /^hm+$/;
	const hmm = cleanedMessage.find(w => hmmPattern.test(w));
	if (hmm) {
		const sarcasticResponse =
			"H" +
			Array(hmm.length)
				.fill("m")
				.join("");
...
// Cod
exports.cod = (message, cleanedMessage, client) => {
...
// I'm davide
exports.davide = (message, cleanedMessage, client) => {
